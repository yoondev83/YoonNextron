...
const UserContact: React.FC<{ userData: any; contactClass: string; contactClickHandler: (uid: string) => void }> = props => {
    const classes = useStyles({});

    return <div className={props.contactClass} key={props.userData.uid} onClick={e => props.contactClickHandler(props.userData.uid)}>
